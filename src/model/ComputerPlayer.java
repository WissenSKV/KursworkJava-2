...
public class ComputerPlayer extends Player {
    ...
    private void getMoveWeight(Game var1, Move var2) {
        ...
        if (!var1.move(var2.getStartIndex(), var2.getEndIndex())) {
            ...
            var10 = var7.get(var6);
            boolean var12 = var10 == 7 || var10 == 5;
            boolean var13 = true;
            int var14;
            if (var8) {
                var13 = MoveLogic.isSafe(var7, var4);
                var14 = this.getSkipDepth(var1, var6, !var1.isP1Turn());
                if (var13) {
                    var2.changeWeight(20.0 * (double)var14 * (double)var14);
                } else {
                    var2.changeWeight(20.0);
                }
            } else {
                var14 = this.getSkipDepth(var1, var5, var1.isP1Turn());
                var2.changeWeight(25.0 * (double)var14 * (double)var14);
            }
            ...
            if (var9 && var13) {
                ...
                var2.changeWeight(-40.0 * (var12 ? 2.0 : 1.0));
            } else {
                var2.changeWeight(-40.0);
            }
