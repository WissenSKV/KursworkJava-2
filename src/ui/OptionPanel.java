...
public class OptionPanel extends JPanel {
    ...
    public OptionPanel(CheckersWindow var1) {
        ...
        String[] var3 = new String[]{"Human", "Computer"};
    ...
    private void handleNetworkUpdate(NetworkWindow var1, ActionEvent var2) {
        if (var1 != null && this.window != null && var2 != null) {
            ...
            if (var2.getID() == 1) {
                ...
                int var9 = var1.getSourcePort();
                var8[0] = "" + var9;
                var8[1] = var6 ? "1" : "0";
                Command var10 = new Command("CONNECT", var8);
                String var11 = var10.send(var5, var4);
                if (var11.isEmpty()) {
                    var1.setMessage("  Error: could not connect to " + var5 + ":" + var4 + ".");
                } else {
                    String[] var12;
                    String var13;
                    if (var11.startsWith("DENIED")) {
                        var12 = var11.split("\n");
                        var13 = var12.length > 1 ? var12[1] : "";
                        if (var13.isEmpty()) {
                            var1.setMessage("  Error: the other client refused to connect.");
                        } else {
                            var1.setMessage("  " + var13);
                        }
                    } else if (var11.startsWith("ACCEPTED")) {
                        ...
                        var13 = var12.length > 1 ? var12[1] : "";
                        var7.setSid(var13);
                        Command var14 = new Command("GET-STATE", new String[]{var13, null});
                        var11 = var14.send(var5, var4);
                        var12 = var11.split("\n");
                        String var15 = var12.length > 1 ? var12[1] : "";
                        this.window.setGameState(var15);
                    } else {
