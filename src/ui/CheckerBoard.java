...
public class CheckerBoard extends JButton {
    ...
    public CheckerBoard(CheckersWindow var1, Game var2, Player var3, Player var4) {
        ...
        super.setBackground(Color.decode("#006a9e"));
        this.addActionListener(new ClickListener());
        this.game = var2 == null ? new Game() : var2;
        this.lightTile = Color.decode("#efded4");
        this.darkTile = Color.decode("#5c4e46");
        this.window = var1;
    ...
    public void paint(Graphics var1) {
        ...
        for(int var12 = 0; var12 < 8; ++var12) {
            for(var11 = (var12 + 1) % 2; var11 < 8; var11 += 2) {
                var1.fillRect(var8 + var11 * var7, var9 + var12 * var7, var7, var7);
            }
        }
        ...
        for(var11 = 0; var11 < 8; ++var11) {
            var13 = var9 + var11 * var7 + 4;

            for(int var14 = (var11 + 1) % 2; var14 < 8; var14 += 2) {
                int var15 = var17.get(var14, var11);
                if (var15 != 0) {
        ...
        if (var5 != 0 && var5 != -1) {
            if (var2 ^ (var5 == 6 || var5 == 7)) {
                ...
                do {
                    ...
                    Point var9 = (Point)var7.next();
                    var8 = Board.toIndex(var9);
                } while(var8 == var4 || MoveGenerator.getSkips(var1, var8).isEmpty());
